                ...
                <div className="profile tables">
                    <div className="profilediv">
                        ...
                        <div className="contentdiv">
                            ...
                            <p className="username">{ this.props.currentUser.user ?  this.props.currentUser.user.name : ''}</p>
                            <span className="labelunameemail">EMAIL</span>
                            <p className="useremail">{ this.props.currentUser.user ?  this.props.currentUser.user.email : ''}</p>
                            <Divider />
                            ...
                            <form>
                                <TextField
                                    ...
                                    className="textfieldspasword"
                                    type="password"
                                    onChange={ this.changeHandler.bind(this,'oldPassword') }
                                ...
                                <TextField
                                    ...
                                    className="textfieldspasword"
                                    type="password"
                                    onChange={ this.changeHandler.bind(this,'newPassword') }
