            ...
            <div className="payment">
                {this.props.loading
                    ...
                    : <div className="cards">
                        ...
                        {/*select card modal*/}
                        <div className={this.state.addCardToggled || this.state.billingToggled || selectPlanisSame
                            ? 'hide'
                            : ''}>
                            {this.props.cards.length
                                ? this.props.cards.map((card, i) => {
                                    return <div className={this.state.selectedCard.cardId == card.cardId
                        ...
                        {/*addcard modal*/}
                        <div className={this.state.addCardToggled
                            ? ''
                            : 'hide'}>
...
const mapStateToProps = (state, selfProps) => {
    return {cards: state.cards, planId: selfProps.planId, appId: selfProps.appId, loading: state.loader.modal_loading}
}
