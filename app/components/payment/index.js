                        ...
                        {this.state.loading
                            ...
                            : <div className="cards">
                                ...
                                <SelectCard planId={this.props.planId} addCardToggled={this.state.addCardToggled} billingToggled={this.state.billingToggled} cards={this.state.cards} selectedCard={this.state.selectedCard} selectCard={this.selectCard.bind(this)} getCardType={this.getCardType.bind(this)} purchaseButton={this.purchaseButton.bind(this)} toggleAddcard={this.toggleAddcard.bind(this)} toggleBilling={this.toggleBilling.bind(this)} selectedPlan={this.state.selectedPlan}/> {!selectPlanisSame
                                    ? <Addcard showBackBtn={this.state.showBackBtn} addCardToggled={this.state.addCardToggled} cardDetails={this.state.cardDetails} cardDetailChangeHandler={this.cardDetailChangeHandler.bind(this)} addCardToggled={this.state.addCardToggled} addCardButton={this.addCardButton.bind(this)} toggleAddcard={this.toggleAddcard.bind(this)}/>
                                    : null}
